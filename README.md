...
Entrada a **Build with Gemini XPRIZE** (xprize.devpost.com) · Categoría **Entrepreneurship & Job Creation**.

## Qué hace

1. Subes captura de tu cv, tu perfil o una foto de tu trabajo — o lo escribes
...
5. Escribes por WhatsApp, recibes el link de pago de monto fijo ($5.990) y el pack llega por ahí mismo
...
Tus datos se procesan en el momento y no se almacenan.
...
```bash
curl -s "https://primer-cliente.vercel.app/api/health"
curl -s "https://primer-cliente.vercel.app/api/health?full=1"
```
